  ...
  public:
    ...
    */
    ...
    /* 
      ...
      @param 'hideArrow_' (optional) - set to true to hide the button arrow
      @param 'useRightArrow_' (optional) - use the arrow on the right side
      values GEM_READONLY (alias for true)
    */
    GEMItem(const char* const title_, void (*buttonAction_)(), bool readonly_ = false, bool hideArrow_ = false, bool useRightArrow_ = false);
    /* 
